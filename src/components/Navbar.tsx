      ...
      >
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
          <div style={{
            ...
            <svg viewBox="75 55 300 340" xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges" width="32" height="32">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <Link
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.boxShadow = "0 0 30px rgba(124,58,237,0.6)"; (e.currentTarget as HTMLElement).style.transform = "translateY(-1px)"; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.boxShadow = "0 0 20px rgba(124,58,237,0.3)"; (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; }}
          >
            Start Building →
          </Link>
          <button
        ...
        <div style={{
          ...
          {navLinks.map((l) => (
            <Link
              ...
              style={{ color: "#CCC", textDecoration: "none", fontSize: "1rem", fontWeight: 500 }}
            >
              {l.label}
            </Link>
          ))}
