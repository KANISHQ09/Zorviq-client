    ...
    >
      <div
        style={{
          ...
          transition: "width 0.4s cubic-bezier(0.4,0,0.2,1), max-width 0.4s cubic-bezier(0.4,0,0.2,1), background 0.4s cubic-bezier(0.4,0,0.2,1), border-radius 0.4s cubic-bezier(0.4,0,0.2,1), border 0.4s cubic-bezier(0.4,0,0.2,1), box-shadow 0.4s cubic-bezier(0.4,0,0.2,1)",
          background: scrolled
            ? "rgba(10,10,10,0.88)"
            : "transparent",
      ...
      >
        <div
          style={{
            ...
            gap: "24px",
            transition: "padding 0.4s cubic-bezier(0.4,0,0.2,1), height 0.4s cubic-bezier(0.4,0,0.2,1)",
          }}
        >
          {/* Logo */}
          <Link
