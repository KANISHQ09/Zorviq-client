...
function ZorviqMark() {
  return (
    <svg
      className="zorviq-loading__logo"
...
export function ZorviqLoadingBar({
  label = "Loading",
  detail = "Preparing your Zorviq workspace",
  variant = "section",
  className,
}: ZorviqLoadingBarProps) {
  return (
    <div
      className={clsx("zorviq-loading", `zorviq-loading--${variant}`, className)}
      role="status"
      aria-live="polite"
      aria-busy="true"
    >
      <div className="zorviq-loading__inner">
        <div className="zorviq-loading__brand">
          <span className="zorviq-loading__mark">
            <ZorviqMark />
          </span>
          <span className="zorviq-loading__name">ZORVIQ</span>
        </div>
        <div className="zorviq-loading__copy">
          <span>{label}</span>
          <small>{detail}</small>
        </div>
        <div className="zorviq-loading__track" aria-hidden>
          <span />
        </div>
      </div>
    </div>
